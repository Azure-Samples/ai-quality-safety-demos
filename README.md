...
This repository contains a collection of Python scripts that demonstrate how to use the OpenAI API and Azure AI Evaluation SDK to evaluate the quality and safety of AI-generated content. The scripts use Azure AI resources configured through environment variables. The `safety_eval.py` script also requires an Azure AI Project. See below for setup details.
...
Provision the Azure AI resources for this repo, then run the samples with the generated `.env` file and an authenticated Azure identity.
...
3. Provision the Azure AI resources:
